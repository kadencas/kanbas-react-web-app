...
export default function QueryParamater() {
    ...
    return (
        <div id="wd-query-parameters">
            ...
            <a id="wd-query-parameter-subtract" className="btn btn-warning me-2"
                href={`${REMOTE_SERVER}/lab5/calculator?operation=subtract&a=${a}&b=${b}`}>
                Divide {a} / {b}
            </a>
            <a id="wd-query-parameter-subtract" className="btn btn-success"
                href={`${REMOTE_SERVER}/lab5/calculator?operation=subtract&a=${a}&b=${b}`}>
                Multiply {a} * {b}
            </a>
            <hr />
